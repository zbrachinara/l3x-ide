...
var clipboard = null,
  wasm_memory, FS, GL, Module, wasm_exports, emscripten_shaders_hack, importObject, ctx, js_objects, unique_js_id, quad_socket, connected, received_buffer, uid, ongoing_requests, plugins = [],
  high_dpi = !1;
    ...
    run_animation_loop: function() {
      canvas.onmousemove = function(e) {
        ...
        for (let n of e.dataTransfer.files) {
          ...
          console.log(`file: ${new TextDecoder().decode(i)}`)
          c.set(new Uint8Array(i), 0), wasm_exports.on_file_dropped(o, t, a, s)
          console.log("call to on_file_dropped completed successfully")
        }
        wasm_exports.on_files_dropped_finish()
      }, window.requestAnimationFrame(animation)
    },
    fs_load_file: function(e, t) {
      var n, o = UTF8ToString(e, t),
        s = FS.unique_id;
      return FS.unique_id += 1, n = new XMLHttpRequest, n.open("GET", o, !0), n.responseType = "arraybuffer", n.onload = function() {
        if (this.status == 200) {
